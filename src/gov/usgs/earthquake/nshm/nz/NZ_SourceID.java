...
public enum NZ_SourceID {
  ...
  private static final Map<FocalMech, Double> SS_MAP =
      ImmutableMap.of(STRIKE_SLIP, 1.0, REVERSE, 0.0, NORMAL, 0.0);
  private static final Map<FocalMech, Double> R_MAP =
      ImmutableMap.of(STRIKE_SLIP, 0.0, REVERSE, 1.0, NORMAL, 0.0);
  private static final Map<FocalMech, Double> N_MAP =
      ImmutableMap.of(STRIKE_SLIP, 0.0, REVERSE, 0.0, NORMAL, 1.0);
  private static final Map<FocalMech, Double> SS_R_MAP =
      ImmutableMap.of(STRIKE_SLIP, 0.5, REVERSE, 0.5, NORMAL, 0.0);
  // private static final Map<FocalMech, Double> SS_N_MAP =
  // ImmutableMap.of(STRIKE_SLIP, 0.5, REVERSE, 0.0, NORMAL, 0.5);
